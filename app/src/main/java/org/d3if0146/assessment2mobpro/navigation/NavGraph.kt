...
import org.d3if0146.assessment2mobpro.ui.screen.DetailScreen
...
fun SetupNavGraph(navController: NavHostController = rememberNavController()){
    NavHost(
        ...
        composable(
            ...
            arguments = listOf(
                navArgument(KEY_ID_MOBIL) { type = NavType.LongType }
            )
        ) {navBackStackEntry ->
            val id = navBackStackEntry.arguments?.getLong(KEY_ID_MOBIL)
